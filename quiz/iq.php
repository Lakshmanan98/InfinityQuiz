...
function func(){
	...
	xmlhttp.open("GET", "text.json", true);
...
xmlhttp.send();
	...
	{
	window.location.href="result.php?iq=" + count;
	}
}
function checkans(){
	k=-1;
...
var xmlobj = new XMLHttpRequest();
	xmlobj.open("GET", "text.json", true);
...
var x = setInterval(function() {
    ...
    if (distance < 0) {
        clearInterval(x);
        window.location.href=window.location.href="result.php?iq=" + count;
    }
}, 1000);
</script>
