...
body {
	...
	height: 90vh;
	color: black;
	background: linear-gradient(#d50be0, #1b73e5, #791de2, #d70fdb, #e00b2f);
...
function func(){
	...
	xmlhttp.open("GET", "aps.json", true);
...
xmlhttp.send();
	...
	{
	window.location.href="result.php?aps=" + count;
	}
}
function checkans(){
	k=-1;
...
var x = setInterval(function() {
    ...
    if (distance < 0) {
        clearInterval(x);
        window.location.href=window.location.href="result.php?aps=" + count;
    }
}, 1000);
</script>
